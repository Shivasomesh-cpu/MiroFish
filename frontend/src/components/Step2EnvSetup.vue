...
.scroll-container::-webkit-scrollbar-thumb {
  background: var(--mf-border, rgba(139, 92, 246, 0.3));
  border-radius: 3px;
}
...
.info-row {
  ...
  align-items: center;
  padding: 8px 0;
  border-bottom: 1px dashed var(--mf-border, rgba(139, 92, 246, 0.15));
}
...
.profiles-preview {
  margin-top: 20px;
  border-top: 1px solid var(--mf-border, rgba(139, 92, 246, 0.15));
  padding-top: 16px;
}
...
.timeline-hour {
  flex: 1;
  background: var(--mf-border, rgba(139, 92, 246, 0.2));
  border-radius: 2px;
  transition: all 0.2s;
}
...
.mini-bar {
  height: 4px;
  background: linear-gradient(90deg, var(--mf-accent, #8b5cf6), #ec4899);
  border-radius: 2px;
  min-width: 4px;
  max-width: 40px;
}
...
.section-bio {
  ...
  background: var(--mf-bg-tertiary, #1a1a2e);
  border-radius: 10px;
  border-left: 3px solid var(--mf-accent, #8b5cf6);
}
...
.dimension-card {
  ...
  padding: 12px;
  border-radius: 8px;
  border-left: 3px solid var(--mf-border, rgba(139, 92, 246, 0.3));
  transition: all 0.2s;
}

.dimension-card:hover {
  background: rgba(139, 92, 246, 0.1);
  border-left-color: var(--mf-accent, #8b5cf6);
}
...
.posts-timeline {
  ...
  gap: 16px;
  padding-left: 8px;
  border-left: 2px solid var(--mf-border, rgba(139, 92, 246, 0.2));
  margin-top: 12px;
}
...
.switch-track::after {
  ...
  width: 16px;
  height: 16px;
  background: var(--mf-text-primary, #f1f5f9);
  border-radius: 50%;
...
.minimal-slider {
  ...
  border-radius: 2px;
  outline: none;
  background-image: linear-gradient(var(--mf-accent, #8b5cf6), var(--mf-accent, #8b5cf6));
...
.minimal-slider::-webkit-slider-thumb {
  ...
  border-radius: 50%;
  background: var(--mf-text-primary, #f1f5f9);
  border: 2px solid var(--mf-accent, #8b5cf6);
  cursor: pointer;
...
.highlight-tip {
  ...
  color: var(--mf-accent, #8b5cf6) !important;
  font-weight: 500;
  cursor: pointer;
}
